...
### Demo dataset
A demo dataset to test IgCaller is provided under the "Demo" folder. If you downloaded IgCaller using the download ZIP button, the following bam files should be manually downloaded and placed in their respective folders:
